...
# ---------- traced setup steps ----------
@traceable(name="load_pdf" ,tags=['pdf','loader'],metadata={'loader':'PypPDFLoader'})
...
@traceable(name="build_vectorstore" ,tags=['embedding','vectorstore'],metadata={'embedding':'sentence-transformers/all-MiniLM-L6-v2'})
